...
import { CalendarClock, Clock, DollarSign, MapPin, MessageSquare, Phone, User } from "lucide-react"
          ...
          <div className="p-4 md:p-5 flex-1 border-b md:border-b-0 md:border-r border-slate-100">
            <div className="flex items-start gap-3">
              <Avatar className="h-12 w-12 border">
                <AvatarImage src={appointment.patientAvatar || `/placeholder.svg?height=48&width=48`} />
                <AvatarFallback className="bg-slate-100">{appointment.patientName.charAt(0)}</AvatarFallback>
              </Avatar>
          ...
          <div className="p-4 md:p-5 md:w-[280px] bg-slate-50">
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="text-sm">
                  <span className="font-medium text-slate-700">
                    {new Intl.NumberFormat("vi-VN").format(appointment.price)} VNĐ
                  </span>
                </div>
              </div>
              {appointment.address && (
                <div className="flex items-start gap-2">
                  ...
                  <div className="text-sm text-slate-600 flex-1">
                    {appointment.isOnline ? "Khám trực tuyến" : appointment.address}
                  </div>
                </div>
              )}
            </div>
