        ...
        <div className="max-w-4xl mx-auto text-center space-y-10">
          ...
          <div className="space-y-6">
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 leading-tight">
              Tiết kiệm thời gian
              <span className="block text-teal-600">chăm sóc sức khỏe</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-600 font-light max-w-2xl mx-auto">
              Đặt lịch khám dễ dàng, không cần chờ đợi - mọi thứ chỉ trong tầm tay
            </p>
          </div>
          ...
          <div className="pt-8">
            <div className="flex flex-wrap justify-center gap-8 text-gray-600">
              <div className="flex items-center gap-2 bg-white/60 backdrop-blur-sm rounded-full px-4 py-2">
                ...
                <span className="font-medium">1000+ Bác sĩ</span>
              </div>
              <div className="flex items-center gap-2 bg-white/60 backdrop-blur-sm rounded-full px-4 py-2">
