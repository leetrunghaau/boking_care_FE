            ...
            <section className="my-10">
                <div className="container mx-auto px-6 max-w-5xl">
                    <div className="relative h-[300px] w-full rounded-lg overflow-hidden">
                        {data ? <>
                            <Image src={data.hospital.thumbnail} alt={data.hospital.name} fill className="object-cover" />
                        </> :
                            <>
                        ...
                        <div className="absolute inset-0 bg-gradient-to-r from-teal-800/60 to-teal-500/60 flex flex-col justify-end p-6">
                            <h1 className="text-4xl text-white font-bold">{data.hospital.name}</h1>
            ...
            <section className="my-10">
                <div className="container mx-auto px-6 max-w-5xl space-y-4">
                    ...
                    <div className="grid sm:grid-cols-2 gap-6 text-sm text-slate-700">
                        ...
                        <div><strong>Giấy phép hoạt động:</strong> {data.hospital.license}</div>
                    </div>
                </div>
            </section>
            ...
            <section className="my-10">
                <div className="container mx-auto px-6 max-w-5xl">
                    <div className="bg-slate-50 rounded-lg p-6 grid grid-cols-2 sm:grid-cols-4 text-center">
                        <div>
                            <h3 className="text-2xl font-bold text-teal-600">{data.hospital.years}+</h3>
                        ...
                        <div>
                            <h3 className="text-2xl font-bold text-teal-600">{data.hospital.doctors}</h3>
                            <p className="text-sm text-muted-foreground">Bác sĩ</p>
                        </div>
                        <div>
                            <h3 className="text-2xl font-bold text-teal-600">{data.hospital.rating} ★</h3>
